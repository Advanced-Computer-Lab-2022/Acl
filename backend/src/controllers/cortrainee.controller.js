           ...
           var mailOptions = {
             ...
             text: 'You are receiving this because you (or someone else) have requested the reset of the password for your account.\n\n' +
               'Please click on the following link, or paste this into your browser to complete the process:\n\n' +
                + 'localhost:3000' + '/corporatetrainee/reset/' + token + '\n\n' +
...
module.exports={showCourses,ChangePass,filterAllCoursesBySubject,finddCourses,findmyCourses,viewall,selectcountry,reset,resetPost,forgetPassPost,forgetPass,answerMcq,showAnswers};