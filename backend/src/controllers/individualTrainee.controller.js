 ...
 service: 'gmail',
  ...
  const reset= async(req, res)=> {
    ...
    const answerMcq = async (req, res) => {
      ...
      module.exports={viewMyCourses,saveData,pay,answerMcq,showAnswers,reset,resetPost,forgetPassPost,ChangePass,filterAllCoursesBySubject,viewall,findmyCourses,finddCourses,filterCoursebyPrice,viewprice,selectcountry,report,
        viewreports,
        followups};