...
let transport= nodemailer.createTransport({
 service: 'gmail',
     ...
     //accessToken:"ya29.a0AeTM1ieMVZBpenPBICXA6zFObVV3zENDTYEAiEMRxQutN09Fmw1aiKnsYXqWH8z1VZHkOP-X6D4bwwivH91txfzPC730fkVQYNZYlimvuvhHNGxN7LDcavYBWEfDCxB7YGo-vkH44C6yjXqLlYb8t3wa17uFaCgYKAa0SARESFQHWtWOmDzsiOVBe6Tm3hh0v15kMsQ0163"
        ...
        var mailOptions = {
          ...
          text: 'You are receiving this because you (or someone else) have requested the reset of the password for your account.\n\n' +
            ...
            + 'localhost:3000' + '/indivualtrainee/reset/' + token + '\n\n' +
  ...
  const showCourses = async (req, res) => {
    ...
    module.exports={showCourses,answerMcq,showAnswers,reset,resetPost,forgetPassPost,ChangePass,filterAllCoursesBySubject,viewall,findmyCourses,finddCourses,filterCoursebyPrice,viewprice,selectcountry};