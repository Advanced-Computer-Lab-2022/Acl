...
function SearchMyCourses({placeHolder}) {
    ...
    const handleChange = event => {
      ...
      await axios.get(`http://localhost:7007/instructor/findMyCourses?userId=${id}`
      ,{
         params: {
            searchWord: word
        } })
  ...
  return (
    ...
    <div className="searchInput">
     <input type="text" placeholder={placeHolder} value= {word} onChange={handleChange}/>  <div className="searchIcon"> 
