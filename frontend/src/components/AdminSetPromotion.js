...
//const {courseId} = params.get("courseId");
  ...
  const handleSubmit = async (e) => {
    ...
    const response = await fetch(`/admin/definepromotion/${id}?courseId${window.location.search}`,{
      method: "PATCH",
    ...
    <div>
      ...
      <TableBody>
          {course && course.map((author) => (
            ...
            onClick={() => window.location.href=`/admin/definepromotion?courseId=${author._id}`}
              key={author._id}
